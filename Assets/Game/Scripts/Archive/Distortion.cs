...
// using Shapes;
//
// public class Distortion : ImmediateModeShapeDrawer
// {
...
//             var content = "Distortion: " + currentVal.ToString("F1");
...
//                 {
//                     currentVal = val;
//                     instance.setParameterByName("Distortion", val);
//                 });
//         }
//     }
//
...
//
//         bounds = other.bounds;
//         instance.setParameterByName("Distortion", currentVal);
//         isTriggered = true;
//     }
//
...
//             return;
//
//         instance.setParameterByName("Distortion", 0);
//         isTriggered = false;
//     }
// }